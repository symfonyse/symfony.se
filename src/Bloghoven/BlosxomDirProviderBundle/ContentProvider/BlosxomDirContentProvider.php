...
namespace Bloghoven\BlosxomDirProviderBundle\ContentProvider;

use Bloghoven\BlosxomDirProviderBundle\Entity\Entry;
use Bloghoven\BlosxomDirProviderBundle\Entity\Category;

use Bloghoven\BlogBundle\ContentProvider\Interfaces\ContentProviderInterface;
use Bloghoven\BlogBundle\ContentProvider\Interfaces\ImmutableCategoryInterface;
