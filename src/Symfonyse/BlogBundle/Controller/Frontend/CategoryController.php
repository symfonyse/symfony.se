...
class CategoryController extends Controller
{
  public function treeAction()
  {
    ...
    return $this->render('SymfonyseAbstractThemeBundle:Category:tree.html.twig', array('roots' => $roots));
  }
  ...
  public function entriesAction(Request $request, $permalink_id)
  {
    ...
    return $this->render('SymfonyseAbstractThemeBundle:Category:entries.html.twig', array('category' => $category, 'pager' => $pagerfanta));
  }
}
